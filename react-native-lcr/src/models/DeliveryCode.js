...
export default class DeliveryCode {
  constructor(bitfield, prevDeliveryCode = {}) {
    ...
    this.shiftTicketPending =
      bitfield[DeliveryBits.ShiftTicketPending] || false;
    this.deliveringGrossPreset =
      bitfield[DeliveryBits.DeliveringGrossPreset] || false;
    this.deliveringNetPreset =
      bitfield[DeliveryBits.DeliveringNetPreset] || false;
    this.finished =
      !this.active && (prevDeliveryCode.finished || prevDeliveryCode.active);
  }
  ...
  needsPrint() {
    return (
      this.active &&
      !this.flowing &&
      (this.ticketPending || this.shiftTicketPending)
    );
  }
